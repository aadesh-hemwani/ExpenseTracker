...
const Chat = () => {
    ...
    return (
        <div className="absolute inset-0 flex flex-col h-full">
            {/* Minimal Header */}
            <div className="pt-[calc(env(safe-area-inset-top)+0.75rem)] px-5 md:px-8 pb-3 shrink-0 flex items-center justify-between">
                <div>
            ...
            {/* Divider */}
            <div className="h-px bg-gray-100 dark:bg-white/5 mx-5 md:mx-8 shrink-0" />
            ...
            {/* Input — floating with backdrop blur */}
            <div className="absolute bottom-28 md:bottom-6 left-0 right-0 px-5 md:px-8 z-10">
