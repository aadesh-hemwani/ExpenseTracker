...
const CalendarView = memo(({ currentMonth, onBack, onSelectDate, selectedDate, expenses = [], calendarDays }: CalendarViewProps) => {
...
const History = () => {
    ...
    const { expenses: monthExpenses } = useExpensesForMonth(view === 'calendar' ? currentMonth : null, stats);
            ...
            <AnimatePresence>
                {selectedDate && (
                    <ExpenseListModal
                        ...
                        expenses={monthExpenses.filter(e => isSameDay(getDate(e.date), selectedDate))}
